  ...
  .end(function (err, res){
    ...
    if (!ok) {
      ...
      if (providedError === 'already_invited') {
        ...
        console.error(providedError)
        fn(new Error('Unknown error, please open a github issue: <a href="https://github.com/gameontext/gameon/issues">https://github.com/gameontext/gameon/issues</a>'))
      }
      return
    }
